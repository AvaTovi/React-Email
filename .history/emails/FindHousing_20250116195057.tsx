        ...
        >
          ...
          >
            ...
            >
                ...
                //shared room section
                style={{
                    width: '250px', height: '28px', transform: 'rotate(0deg)', fontFamily: 'Roboto, sans-serif', fontWeight: 800, fontSize: '18px', lineHeight: '28px', bottom whiteSpace: "nowrap", color: '#515558',
                }}
                >
                    Shared Room
                </div>
