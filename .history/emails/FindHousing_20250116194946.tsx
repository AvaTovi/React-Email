      ...
      >
        ...
        >
          ...
          >
            ...
            //top right frame
            style={{
                width: '250px', height: '70px', gap: '8px', right: 0, display: 'flex', position: 'relative', border: '2px solid red',
            }}
            >
                <div
                //shared room section
                style={{
                    width: '250px', height: '28px', transform: 'rotate(odeg)', fontFamily: 'Roboto, sans-serif', fontWeight: 800, fontSize: '18px', lineHeight: '28px', whiteSpace: "nowrap", color: '#515558',
                }}
                >
                    Shared Room
                </div>
                ...
                //long text section
                style={{
                    width: '250px', height: '34px', fontFamily: 'Roboto, sans-serif', fontWeight: 400, fontSize: '12px', lineHeight: '17.16px', letterSpacing: '0.1px', position: 'absolute', color: '#545558',
                }}
                >
